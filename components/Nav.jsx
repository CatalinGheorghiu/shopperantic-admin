  ...
  return (
    <header
      className={
        ...
        ' fixed top-0 h-full w-11/12 bg-slate-100 p-4 text-gray-500 transition-all md:static md:w-auto'
      }
    >
      {/*<div className="flex items-center p-4 shadow-border-bottom md:hidden">*/}
      {/*  /!* Drawer button *!/*/}
      ...
      {/*  /!* Logo *!/*/}
      {/*  <div className="mx-6 flex grow justify-center text-center">*/}
      {/*    <Logo />*/}
      {/*  </div>*/}
